  ...
  return (
    <div className="flex w-full bg-zinc-100">
      ...
      <div className="w-full">
        ...
        <div className="m-4 flex gap-4">
          <div className="flex-1 bg-white rounded-[10px] p-[20px]">
            <div className="flex justify-between">
              <div>
                <h4 className="text-[18px] text-black font-[700]">
            ...
            <div className="mt-8 space-y-[22px]">
              <div className=" flex items-start gap-[10px]">
                ...
                <div className="space-y-[11px] ">
                  <h6 className="text-[14px] text-black  font-[700]">
                    Add availability
                  </h6>
                  <p className="text-[12px] text-black ">
                    Add your availability so your followers can select a slot
                  </p>
                  <Button bg={"#F97316"} variant="default">
                    Add Availability
                  </Button>
                </div>
              </div>
          ...
          <div className=" bg-white rounded-[10px] p-[20px] space-y-[20px] min-w-[35%]">
            <h4 className="text-[18px] text-black font-[700]">Friend list</h4>

            <div className="w-full flex justify-between">
              <div className="flex gap-2">
                <img src="/assets/amanda.svg" alt="" />
                <div>
                  <h4 className="text-[18px] text-black leading-5 font-[700]">
                    Amanda
                  </h4>

                  <p className="text-[#64748B]">@amanda089</p>
                </div>
              </div>
        ...
        <div className="mx-4 flex gap-[20px]">
          <div className="bg-white p-[20px] rounded-[10px]">
            <img
              src="/assets/note-2.svg"
              alt=""
              className="p-4 border border-[#E2E8F0] rounded-[19px]"
            />

            <div className="my-8">
              <h4 className="text-[18px] font-[700]">Request feature</h4>
              <p className="text-[16px]">
                Share your feature request or feedback, we’re all ears
              </p>
            </div>

            <button className="border-b border-[#3F88EC] flex gap-2 items-center text-[#3F88EC]">
          ...
          <div className="bg-white p-[20px]  rounded-[10px]">
            ...
            <div className="my-8">
              <h4 className="text-[18px] font-[700]">Help centre</h4>
              <p className="text-[16px]">
          ...
          <div className="bg-white p-[20px] min-w-[40%] rounded-[10px]">
            <div className="mb-4">
              <h4 className="text-[18px] font-[700]">New Bookings</h4>
              <p className="text-[16px]">No Booking Right Now :)</p>
            </div>
