...
const Seller = () => {
  return (
    <div className="mt-[22px] border border-[#000000] flex lg:flex-row flex-col  bg-[#FED7AA] p-[10px] shadow-custom-black">
        <Card
          px="16px"
          py="20px"
          bg="#FDF6EA"
        ...
        >
          ...
          <div className="flex flex-col items-start space-y-2 w-full">
            <Text className="md:text-[20px] text-[18px]" fw={700} lh={"25.5px"}>
              James Bond
            </Text>
            <Text className="md:text-[16px] text-[14px]" color="#1E1E1E" fw={400} lh={"20.4px"}>
        ...
        <div className="flex flex-col gap-[30px] bg-transparent md:px-[20px] py-[8px] px-[0px] w-[60%] lg:w-2/3 w-full">
          <div className="flex flex-wrap gap-[10px] justify-between items-start">
            <div className="flex md:gap-[18px] gap-[11px] flex-wrap">
              <div className="space-y-[6px] rounded-[3px] md:px-[26px] px-[16px] py-[11px] bg-[#FFF0DB] border border-[#B78F61] border-b-[2px] border-l-[2px]">
                <Text fw={400} fz="12px" lh={"15.3px"}>
                  TOP
                </Text>
                <Text className='md:text-[25px] text-[20px]' fw={700} lh={"31.87px"}>
                  10%
                </Text>
              </div>
              <div className="space-y-[6px] rounded-[3px] md:px-[26px] px-[16px] py-[11px] bg-[#FFF0DB] border border-[#B78F61] border-b-[2px] border-l-[2px]">
              ...
              <div className="flex items-center bg-white p-[2px]">
                <Text
                  className="h-[100%] w-auto flex items-center bg-[#EEB4A2]"
                >
                  <img
                    className="bg-[#FEE9E2] md:p-[15px] p-[11px] h-full md:w-[70px] w-[56px] object-contain"
                    src="/assets/star.svg"
                    alt="star"
                    width={"100%"}
                    height={"100%"}
                  />
                  <span className="flex flex-col p-[14px] font-[700] md:text-[20px] text-[16px] leading-[25.5px]">
                    TOP RATED
            ...
            <div className="md:block hidden  flex items-center bg-[#FDF6EA] p-[10px] border border-[#000000] rounded-[36px] ">
          ...
          <div className='flex flex-col gap-[10px]'>
            <Text fw={700} lh={"22.95px"} className='md:text-[18px] text-[16px]'>
              About Seller
            </Text>
            <Text fw={400} lh={"24px"} className='md:text-[16px] text-[14px]'>
          ...
          <div className='md:hidden block flex justify-between items-end'>
            <div className='flex flex-col gap-[10px]'>
          <Text fw={700} lh={"22.95px"} className='md:text-[18px] text-[16px]'>
            Social
          </Text>
            <Group gap="10px" justify="flex-start" wrap="nowrap">
              <ActionIcon
                h="50px"
                w="50px"
                bg="#FFFFFF"
